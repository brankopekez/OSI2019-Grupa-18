 ...
 * @file cmpfn.c
 *
 * This file implements the comparison functions exported by the cmpfn.h interface. The reason to centralize them
 * in a single module is to allow the same functions to be shared among many different modules.
 */
