 ...
 *
 * This module implements the strlib library by mapping all functions into the appropriate calls to the ANSI <string.h>
 * interface.  The implementations of the individual functions are all quite simple and do not require individual
 * comments. For descriptions of the behavior of each function, see the interface.
 */
...
/**
 * @brief This function dynamically allocates space for a string of len characters, leaving room for the null character
 * at the end.
 *
 * Usage: @code s = createString(len); @endcode
 */
